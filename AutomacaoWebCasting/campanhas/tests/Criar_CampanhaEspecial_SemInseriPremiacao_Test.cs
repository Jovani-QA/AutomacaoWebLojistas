...
{
    [TestFixture]
    class Criar_CampanhaEspecial_SemInseriPremiacao_Test
    {
        private Config config;
        private User user;
        private PageLogin page;
        private Actions actions;
        private Criar_CampanhaEspecial_Page campanhaespecialPage; // Adicione uma instância de MesaPage
        private Criar_CampanhaEspecial_Actions campanhaEspecialActions; // Adicione uma instância de MesaActions

        String nomeCampanha = "Refactor Testes";
        ...
        public void Setup()
        {
            ...
            campanhaespecialPage = new Criar_CampanhaEspecial_Page(config.Driver); // Inicialize MesaPage com o driver
            campanhaEspecialActions = new Criar_CampanhaEspecial_Actions(campanhaespecialPage, config.Driver); // Inicialize MesaActions com a instância de MesaPage
