...
{
    class Criar_CampanhaEspecial_Actions
    {
        private Criar_CampanhaEspecial_Page campanhaespecialPage;
        private IWebDriver driver;

        public Criar_CampanhaEspecial_Actions(Criar_CampanhaEspecial_Page campanhaespecialPage, IWebDriver driver)
        {
